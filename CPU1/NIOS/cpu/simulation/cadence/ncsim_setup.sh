...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  ...
  cp -f $QSYS_SIMDIR/submodules/cpu_RAM.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cpu_mm_interconnect_0_rsp_demux_003.sv"                     -work rsp_demux_003                         -cdslib ./cds_libs/rsp_demux_003.cds.lib                        
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cpu_mm_interconnect_0_cmd_mux_003.sv"                       -work cmd_mux_003                           -cdslib ./cds_libs/cmd_mux_003.cds.lib                          
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cpu_mm_interconnect_0_router_005.sv"                        -work router_005                            -cdslib ./cds_libs/router_005.cds.lib                           
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/cpu_LED_Tens.v"                                             -work LED_Tens                              -cdslib ./cds_libs/LED_Tens.cds.lib                             
