...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cpu_mm_interconnect_0_rsp_demux_003.sv"                     -work rsp_demux_003                        
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cpu_mm_interconnect_0_cmd_mux_003.sv"                       -work cmd_mux_003                          
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/cpu_mm_interconnect_0_router_005.sv"                        -work router_005                           
  ...
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/cpu_Input_Timer.v"                                          -work Input_Timer                          
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/cpu_CPU.v"                                                  -work CPU                                  
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/cpu_Buzzer.v"                                               -work Buzzer                               
